...
func (x *AllRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *AllRequest) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *AllResponse) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_data_data_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x3a, 0x0a, 0x0a, 0x61, 0x6c, 0x6c, 0x52, 0x65,
	...
	0x61, 0x74, 0x61, 0x22, 0x3b, 0x0a, 0x0b, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x32, 0x34, 0x0a, 0x03, 0x41, 0x6c, 0x6c, 0x12, 0x2d, 0x0a, 0x06, 0x67, 0x65, 0x74, 0x41, 0x6c,
	0x6c, 0x12, 0x10, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x61, 0x6c, 0x6c, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x72, 0x73, 0x61, 0x39, 0x37, 0x2f, 0x6e, 0x65, 0x77, 0x2d,
	0x67, 0x72, 0x70, 0x63, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x64, 0x61, 0x74, 0x61,
...
var file_data_data_proto_goTypes = []interface{}{
	(*AllRequest)(nil),  // 0: data.allRequest
	(*AllResponse)(nil), // 1: data.allResponse
}
var file_data_data_proto_depIdxs = []int32{
	0, // 0: data.All.getAll:input_type -> data.allRequest
	1, // 1: data.All.getAll:output_type -> data.allResponse
